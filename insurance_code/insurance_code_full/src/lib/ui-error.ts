import { isAuthGateError, resolveApiErrorMessage } from '@contracts/error-ui';
...
export function isAuthRequiredError(code: string | undefined | null) {
  return isAuthGateError(code);
}
