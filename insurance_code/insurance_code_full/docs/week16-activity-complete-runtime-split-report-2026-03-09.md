# Week16 activity complete + reward 总结报告
...
2. 把本轮必需的 activity owned routes 接进 gateway 路由表和切流开关
...
3. Week16 总 gate / smoke / release-check
...
2. `npm run test:smoke:activity-points-contract:week16`
3. `npm run test:smoke:week16-activity-complete`
4. `npm run release-check:week16-activity-complete`
5. `npm run gate:week16-activity-complete`
...
1. `./reports/week16-activity-complete-latest.md`
2. `./reports/week16-activity-complete-latest.json`

## 6. 实际执行命令

1. `node scripts/check_week16_activity_service_pilot.mjs`
2. `npm run release-check:week16-activity-complete`
3. `npm run gate:week16-activity-complete`
...
1. `activity complete + reward` 所需编排和接线成立
