...
const steps = [
  ...
  {
    name: 'week14-learning-route-ownership',
    cmd: ['node', 'scripts/check_week14_learning_complete_rollout.mjs'],
  },
  {
    name: 'week14-learning-complete-smoke',
    cmd: ['node', 'scripts/smoke_week14_learning_complete_suite.mjs'],
  },
];
...
async function main() {
  ...
  for (const step of steps) {
    console.log(`[week14-learning-gate] running=${step.name}`);
