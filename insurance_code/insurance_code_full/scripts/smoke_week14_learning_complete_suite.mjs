...
const steps = [
  {
    name: 'learning-service-complete-smoke',
    cmd: ['node', 'scripts/smoke_learning_service_complete_phase2.mjs'],
  },
  {
    name: 'learning-points-contract-smoke',
    cmd: ['node', 'scripts/smoke_points_learning_reward_week13.mjs'],
  },
  {
    name: 'week14-learning-complete-release-check',
    cmd: ['node', 'scripts/smoke_week14_learning_complete.mjs'],
  },
];
...
async function main() {
  ...
  for (const step of steps) {
    console.log(`[week14-learning-smoke] running=${step.name}`);
