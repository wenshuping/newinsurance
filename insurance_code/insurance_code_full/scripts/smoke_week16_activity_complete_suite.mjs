...
const steps = [
  ...
  {
    name: 'activity-points-contract-smoke',
    cmd: ['node', 'scripts/smoke_activity_points_reward_phase1.mjs'],
  },
  {
    name: 'week16-activity-release-check',
    cmd: ['node', 'scripts/smoke_week16_activity_complete.mjs'],
  },
];
...
async function main() {
  ...
  for (const step of steps) {
    console.log(`[week16-activity-smoke] running=${step.name}`);
